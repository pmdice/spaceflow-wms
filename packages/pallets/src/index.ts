...
// ── Framework-agnostic errors (callers map these to HTTP / framework exceptions) ─

export class PalletValidationError extends Error {
    constructor(public readonly issues: unknown) {
        super('Invalid pallet action payload');
        this.name = 'PalletValidationError';
    }
}

export class PalletNotFoundError extends Error {
    constructor(id: string) {
        super(`Pallet ${id} not found`);
